if (!surface_exists(surface) or surface_get_width(surface) != oCamera.viewWidth)
...
for(var i = 0; i < bubbleCount; i++) {
    ...
    draw_sprite_ext(sBGBubbles, _b.index, round((_b.x-_x + lengthdir_x(_wave, _b.dir + 90)) / _bubbleScale) * _bubbleScale , round((_b.y-_y + lengthdir_y(_wave, _b.dir + 90)) / _bubbleScale) * _bubbleScale, _bubbleScale, _bubbleScale, 0, c_white, _b.alpha);
}
